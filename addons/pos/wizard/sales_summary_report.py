...
class sales_summary_report(models.TransientModel):
	...
	sales_ids = fields.One2many('sales.summary.line','sales_id','Sales')
...
class sales_summary_line(models.TransientModel):
