...
class BtAsset(models.Model):   
    ...
    name = fields.Char(string='Meterial Name', required=True)
    ...
    asset_code = fields.Char(string='Inma Coding No')
    ...
    serial_no = fields.Char(string='Serial No/Part No', track_visibility='always')
